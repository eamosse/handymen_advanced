...
internal val Database_Users: List<User> = listOf(
    User(
        id = Identity(localId = 1, externalId = null), name = "Carole",
    ...
    User(
        id = Identity(localId = 2, externalId = null),
        name = "Jack",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
        address = "Saint-Pierre-du-Mont ; 5km",
    ...
    User(
        id = Identity(localId = 3, externalId = null),
        name = "Chloé",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
    ...
    User(
        id = Identity(localId = 4, externalId = null),
        name = "Vincent",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
    ...
    User(
        id = Identity(localId = 5, externalId = null),
        name = "Elodie",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
    ...
    User(
        id = Identity(localId = 6, externalId = null),
        name = "Sylvain",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
        address = "Saint-Pierre-du-Mont ; 6km",
    ...
    User(
        id = Identity(localId = 7, externalId = null),
        name = "Laetitia",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
    ...
    User(
        id = Identity(localId = 8, externalId = null),
        name = "Dan",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
    ...
    User(
        id = Identity(localId = 9, externalId = null),
        name = "Joseph",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
    ...
    User(
        id = Identity(localId = 10, externalId = null),
        name = "Emma",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
        address = "Saint-Pierre-du-Mont ; 1km",
    ...
    User(
        id = Identity(localId = 11, externalId = null),
        name = "Patrick",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
        address = "Saint-Pierre-du-Mont ; 5km",
    ...
    User(
        id = Identity(localId = 12, externalId = null),
        name = "Ludovic",
        avatarUrl = "https://api.dicebear.com/9.x/miniavs/png",
        address = "Saint-Pierre-du-Mont ; 5km",
